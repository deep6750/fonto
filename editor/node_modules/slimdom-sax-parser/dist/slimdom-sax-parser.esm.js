...
function createHandler(parser, options) {
  ...
  // namespaces.
  var document = new Document(); // The node into which new child nodes are inserted. Is rewritten as the handler traverses in and out of elements.
...
function async(xml, options) {
  return new Promise(function (resolve, reject) {
    ...
    var parser = new SaxesParser(mergedOptions);
...
export { DEFAULT_NAMESPACES, DEFAULT_OPTIONS, async, slimdom, sync };
//# sourceMappingURL=slimdom-sax-parser.esm.js.map
