...
function x(a,b,c=null){const d=b.node,e=b.G;if(e)"number"===typeof e.offset&&d===e.parent.childNodes[e.offset]||"string"===typeof e.offset&&d===e.parent.attributes.find(f=>e.offset===f.nodeName)?(a=e.parent,b=e.G):(a=a.getParentNode(d,c),b=e);else{if(cb(d))return null;a=a.getParentNode(d,c);b=null}return a?{node:a,G:b}:null}
function lb(a,b,c=null){const d=b.node;let e,f,h;const k=b.G;if(cb(d))k&&(h=k.offset+1,e=k.parent.childNodes[h]);else if(k)h=k.offset+1,f=x(a,b,null),e=a.getChildNodes(f.node,c)[h];else{for(e=d;e&&(!(e=a.h.getNextSibling(e,c))||10===e.nodeType););return e?{node:e,G:null}:null}return e?db(e,f||x(a,b,c),h):null}
function mb(a,b,c=null){const d=b.node;let e,f;const h=b.G;let k;if(cb(d))h&&(k=h.offset-1,e=h.parent.childNodes[k]);else if(h)k=h.offset-1,f=x(a,b,null),e=a.getChildNodes(f.node,c)[k];else{for(e=d;e&&(!(e=a.h.getPreviousSibling(e,c))||10===e.nodeType););return e?{node:e,G:null}:null}return e?db(e,f||x(a,b,c),k):null}
...
const Xd=(a,b,c,d=w.empty())=>{function e(f){const h=(k,l,n,t)=>{if(t.F()||t.oa())return t;k=t.O();l=f;for(n=k.length-1;1<n;n--){l=gc(a,l).rb;t=l%n;const u=k[t];k[t]=k[n];k[n]=u}return w.create(k)};return w.m(new ub([{key:g("number",1),value:()=>w.m(g(gc(a,f).$b,3))},{key:g("next",1),value:()=>w.m(new Va({value:()=>e(gc(a,f).rb),Ya:!0,localName:"",namespaceURI:"",j:[],arity:0,i:{type:61,g:3}}))},{key:g("permute",1),value:()=>w.m(new Va({value:h,Ya:!0,localName:"",namespaceURI:"",j:[{type:59,g:2}],
arity:1,i:{type:59,g:2}}))}]))}b=d.F()?gc(a):gc(a,Wd(jd(d.first(),1).value));return e(b.rb)};
...
1));a=d.first().value.trim();return w.m(g(a.replace(/\s+/g," "),1))},ie=new Map,je=new Map;function fe(a){if(je.has(a))return je.get(a);let b;try{b=new RegExp(a,"g")}catch(c){throw Error(`FORX0002: ${c}`);}if(b.test(""))throw Error(`FORX0003: the pattern ${a} matches the zero length string`);je.set(a,b);return b}
...
}}];const le=new WeakMap;let me=0;function ne(a,b,c,d,e){if(null===c.M)throw lc(`The function ${a} depends on dynamic context, which is absent.`);return b(c,d,e,w.m(c.M))}
...
a=w;b=a.m;c=c.node;le.has(c)||le.set(c,`id${++me}`);c=le.get(c);return b.call(a,g(c,1))},se=(a,b,c,d)=>A([d],([e])=>{e=e?e.value:null;return null!==e&&jb(b.h,e,null)?w.aa():w.T()});function te(a,b){a=a.toLowerCase();b=b.toLowerCase();return a===b?!0:5>a.length||!a.startsWith(b)?!1:te(a.replace(/-[a-z0-9]+$/,""),b)}
const ue=(a,b,c,d,e)=>{b=b.h;if(d.F())d="";else if(v(d.first().type,1))d=d.first().value;else throw Error("XPTY0004: The first argument of lang must be a string.");if(e)e=e.first().value;else{if(!a||!a.M)throw lc("The function lang depends on dynamic context if a node is not passed as the second argument.");if(!v(a.M.type,53))throw Error("XPTY0004: The context item must be a node.");e=a.M.value}a:{for(a=d;e;)if(1!==e.node.nodeType)e=x(b,e);else if(1===e.node.nodeType){if(d=fb(b,e,"xml:lang")){b=te(d,
a)?w.aa():w.T();break a}e=x(b,e)}b=w.T()}return b},ve=(a,b,c,d)=>A([d],([e])=>{function f(n){let t=0,u=n;for(;null!==u;)(n.node.nodeType!==u.node.nodeType?0:1===u.node.nodeType?u.node.localName===n.node.localName&&u.node.namespaceURI===n.node.namespaceURI:7===u.node.nodeType?u.node.target===n.node.target:1)&&t++,u=mb(h,u,null);return t}if(null===e)return w.empty();const h=b.h;let k="";for(e=e.value;null!==x(b.h,e,null);e=x(b.h,e,null))switch(e.node.nodeType){case 1:var l=e;k=`/Q{${l.node.namespaceURI||
""}}${l.node.localName}[${f(l)}]${k}`;break;case 2:l=e;k=`/@${l.node.namespaceURI?`Q{${l.node.namespaceURI}}`:""}${l.node.localName}${k}`;break;case 3:k=`/text()[${f(e)}]${k}`;break;case 7:l=e;k=`/processing-instruction(${l.node.target})[${f(l)}]${k}`;break;case 8:k=`/comment()[${f(e)}]${k}`}return 9===e.node.nodeType?w.create(g(k||"/",1)):w.create(g("Q{http://www.w3.org/2005/xpath-functions}root()"+k,1))}),we=(a,b,c,d)=>d.map(e=>g(e.value.node.namespaceURI||"",20)),xe=(a,b,c,d)=>d.X({default:()=>
d.map(e=>7===e.value.node.nodeType?g(e.value.node.target,1):g(e.value.node.localName||"",1)),empty:()=>w.m(g("",1))});function ye(a,b,c){if(2===b.node.nodeType)return md(b,c);for(;c;){if(md(b,c))return!0;if(9===c.node.nodeType)break;c=x(a,c,null)}return!1}const ze=(a,b,c,d)=>d.map(e=>{if(!v(e.type,53))throw Error("XPTY0004 Argument passed to fn:root() should be of the type node()");let f;for(e=e.value;e;)f=e,e=x(b.h,f,null);return rb(f)});
var Ae=[{j:[{type:53,g:0}],callFunction:pe,localName:"name",namespaceURI:"http://www.w3.org/2005/xpath-functions",i:{type:1,g:3}},{j:[],callFunction:ne.bind(null,"name",pe),localName:"name",namespaceURI:"http://www.w3.org/2005/xpath-functions",i:{type:1,g:3}},{j:[{type:53,g:3}],callFunction:we,localName:"namespace-uri",namespaceURI:"http://www.w3.org/2005/xpath-functions",i:{type:20,g:3}},{j:[],callFunction:ne.bind(null,"namespace-uri",we),localName:"namespace-uri",namespaceURI:"http://www.w3.org/2005/xpath-functions",
i:{type:20,g:3}},{j:[{type:53,g:2}],callFunction:(a,b,c,d)=>d.N(e=>{if(!e.length)return w.empty();e=td(b.h,e).reduceRight((f,h,k,l)=>{if(k===l.length-1)return f.push(h),f;if(ye(b.h,h.value,f[0].value))return f;f.unshift(h);return f},[]);return w.create(e)}),localName:"innermost",namespaceURI:"http://www.w3.org/2005/xpath-functions",i:{type:53,g:2}},{j:[{type:53,g:2}],callFunction:(a,b,c,d)=>d.N(e=>{if(!e.length)return w.empty();e=td(b.h,e).reduce((f,h,k)=>{if(0===k)return f.push(h),f;if(ye(b.h,f[f.length-
...
function De(a,b){if((v(a.type,4)||v(a.type,6))&&(v(b.type,4)||v(b.type,6))){var c=jd(a,6),d=jd(b,6);return c.value===d.value||isNaN(a.value)&&isNaN(b.value)}return(v(a.type,4)||v(a.type,6)||v(a.type,3))&&(v(b.type,4)||v(b.type,6)||v(b.type,3))?(c=jd(a,3),d=jd(b,3),c.value===d.value||isNaN(a.value)&&isNaN(b.value)):v(a.type,23)&&v(b.type,23)?a.value.namespaceURI===b.value.namespaceURI&&a.value.localName===b.value.localName:(v(a.type,9)||v(a.type,7)||v(a.type,8)||v(a.type,11)||v(a.type,12)||v(a.type,
13)||v(a.type,14)||v(a.type,15))&&(v(b.type,9)||v(b.type,7)||v(b.type,8)||v(b.type,11)||v(b.type,12)||v(b.type,13)||v(b.type,14)||v(b.type,15))?Ob(a.value,b.value):(v(a.type,16)||v(a.type,17)||v(a.type,18))&&(v(b.type,16)||v(b.type,17)||v(b.type,17))?vb(a.value,b.value):a.value===b.value}function Ee(a,b,c){const [d,e]=[b,c].map(f=>({type:1,value:f.reduce((h,k)=>h+=pc(k,a).first().value,"")}));return q(De(d,e))}
function Fe(a,b,c,d){for(;a.value&&v(a.value.type,56);){b.push(a.value);const e=lb(d,a.value.value);a=c.next(0);if(e&&3!==e.node.nodeType)break}return a}
function Ge(a,b,c,d,e){const f=b.h,h=d.value,k=e.value;let l=null,n=null,t=null,u;const z=[],y=[];return{next:()=>{for(;!u;)if(l||=h.next(0),l=Fe(l,z,h,f),n||=k.next(0),n=Fe(n,y,k,f),z.length||y.length){var G=Ee(b,z,y);z.length=0;y.length=0;if(!1===G.value)return u=!0,G}else{if(l.done||n.done)return u=!0,q(l.done===n.done);t||=He(a,b,c,l.value,n.value);G=t.next(0);t=null;if(!1===G.value)return u=!0,G;n=l=null}return p}}}
...
localName:"sort",j:[{type:62,g:3}],i:{type:62,g:3},callFunction:(a,b,c,d)=>A([d],([e])=>{e=e.h.map(f=>f().O());return Lf(a,b,c,e)})},{namespaceURI:"http://www.w3.org/2005/xpath-functions/array",localName:"flatten",j:[{type:59,g:2}],i:{type:59,g:2},callFunction:(a,b,c,d)=>d.N(e=>jc(e.map(Mf)))}];function E(a,b,c,d,e){return e.F()?e:w.m(jd(e.first(),a))}
var Of=[{namespaceURI:"http://www.w3.org/2001/XMLSchema",localName:"untypedAtomic",j:[{type:46,g:0}],i:{type:19,g:0},callFunction:E.bind(null,19)},{namespaceURI:"http://www.w3.org/2001/XMLSchema",localName:"error",j:[{type:46,g:0}],i:{type:39,g:0},callFunction:E.bind(null,39)},{namespaceURI:"http://www.w3.org/2001/XMLSchema",localName:"string",j:[{type:46,g:0}],i:{type:1,g:0},callFunction:E.bind(null,1)},{namespaceURI:"http://www.w3.org/2001/XMLSchema",localName:"boolean",j:[{type:46,g:0}],i:{type:0,
...
localName:"hours-from-time",j:[{type:8,g:0}],i:{type:5,g:0},callFunction:Sf},{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"minutes-from-time",j:[{type:8,g:0}],i:{type:5,g:0},callFunction:Tf},{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"seconds-from-time",j:[{type:8,g:0}],i:{type:4,g:0},callFunction:Uf},{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"timezone-from-time",j:[{type:8,g:0}],i:{type:17,g:0},callFunction:Vf}];function Xf(a,b){const c=b.h,d=b.Ja,e=b.Ma;switch(a.node.nodeType){case 1:const h=d.createElementNS(a.node.namespaceURI,a.node.nodeName);c.getAllAttributes(a.node).forEach(k=>e.setAttributeNS(h,k.namespaceURI,k.nodeName,k.value));for(var f of hb(c,a))a=Xf(f,b),e.insertBefore(h,a.node,null);return{node:h,G:null};case 2:return b=d.createAttributeNS(a.node.namespaceURI,a.node.nodeName),b.value=ib(c,a),{node:b,G:null};case 4:return{node:d.createCDATASection(ib(c,a)),G:null};case 8:return{node:d.createComment(ib(c,
a)),G:null};case 9:f=d.createDocument();for(const k of hb(c,a))a=Xf(k,b),e.insertBefore(f,a.node,null);return{node:f,G:null};case 7:return{node:d.createProcessingInstruction(a.node.target,ib(c,a)),G:null};case 3:return{node:d.createTextNode(ib(c,a)),G:null}}};function Yf(a,b){const c=b.Ma;var d=b.Ja;const e=b.h;if(cb(a.node))switch(a.node.nodeType){case 2:return d=d.createAttributeNS(a.node.namespaceURI,a.node.nodeName),d.value=ib(e,a),d;case 8:return d.createComment(ib(e,a));case 1:const f=a.node.prefix,h=a.node.localName,k=d.createElementNS(a.node.namespaceURI,f?f+":"+h:h);hb(e,a).forEach(l=>{l=Yf(l,b);c.insertBefore(k,l,null)});eb(e,a).forEach(l=>{c.setAttributeNS(k,l.node.namespaceURI,l.node.nodeName,ib(e,l))});k.normalize();return k;case 7:return d.createProcessingInstruction(a.node.target,
ib(e,a));case 3:return d.createTextNode(ib(e,a))}else return Xf(a,b).node}function Zf(a,b,c){let d=a;for(a=x(c,d);null!==a;){if(2===d.node.nodeType)b.push(d.node.nodeName);else{const e=hb(c,a);b.push(e.findIndex(f=>md(f,d)))}d=a;a=x(c,d)}return d}function $f(a,b,c){for(;0<b.length;){const d=b.pop();"string"===typeof d?a=eb(c,a).find(e=>e.node.nodeName===d):a=hb(c,a)[d]}return a.node}
function ag(a,b,c){var d=a.node;if(!(cb(d)||c||a.G))return d;d=b.v;const e=[];if(c)return Yf(a,b);a=Zf(a,e,b.h);c=d.get(a.node);c||(c={node:Yf(a,b),G:null},d.set(a.node,c));return $f(c,e,b.h)};const bg=(a,b,c,d,e)=>d.N(f=>{var h;let k="";for(let l=0;l<f.length;l++){const n=f[l],t=b.Ua&&v(n.type,53)?b.Ua.serializeToString(ag(n.value,b,!1)):null===(h=qc(w.m(n),b).map(u=>jd(u,1)).first())||void 0===h?void 0:h.value;t&&(k+=`{type: ${Da[n.type]}, value: ${t}}\n`)}void 0!==e&&(k+=e.first().value);b.jb.trace(k);return w.create(f)});
var cg=[{j:[{type:59,g:2}],callFunction:bg,localName:"trace",namespaceURI:"http://www.w3.org/2005/xpath-functions",i:{type:59,g:2}},{j:[{type:59,g:2},{type:1,g:3}],callFunction:bg,localName:"trace",namespaceURI:"http://www.w3.org/2005/xpath-functions",i:{type:59,g:2}}];const dg=(a,b,c,d,e)=>{a=void 0===d||d.F()?new Sa("err","http://www.w3.org/2005/xqt-errors","FOER0000"):d.first().value;b="";void 0===e||e.F()||(b=`: ${e.first().value}`);throw Error(`${a.localName}${b}`);};
var eg=[{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"error",j:[],i:{type:63,g:3},callFunction:dg},{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"error",j:[{type:23,g:0}],i:{type:63,g:3},callFunction:dg},{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"error",j:[{type:23,g:0},{type:1,g:3}],i:{type:63,g:3},callFunction:dg},{namespaceURI:"http://www.w3.org/2005/xpath-functions",localName:"error",j:[{type:23,g:0},{type:1,g:3},{type:59,g:2}],i:{type:63,
...
function Fg(a,b,c,d,e){d=Ag(b,c)+"~"+d;if(a.l[d])throw ug(b,c);a.l[d]=e}function Gg(a,b,c){a.D[a.h][b]=c}function Hg(a,b,c){b=Ag(b||"",c);return a.Da[a.h][b]=`${b}[${a.s}]`}function Ig(a,b,c,d){a.Ea[`${Ag(b||"",c)}[${a.s}]`]=d}function Jg(a){a.D.length=a.h;a.Da.length=a.h;a.h--}
var Cg=class{constructor(a){this.o=a;this.s=this.h=0;this.D=[Object.create(null)];this.l=Object.create(null);this.v=null;this.Ea=a&&a.Ea;this.Da=a&&a.Da}va(a,b,c,d=!1){const e=this.l[Ag(a,b)+"~"+c];return!e||d&&e.wb?null===this.o?null:this.o.va(a,b,c,d):e}eb(a,b){const c=Bg(this.Da,Ag(a,b));return c?c:null===this.o?null:this.o.eb(a,b)}Sa(a,b){var c=a.prefix;const d=a.localName;return""===c&&this.v?{localName:d,namespaceURI:this.v}:c&&(c=this.$(c,!1))?{localName:d,namespaceURI:c}:null===this.o?null:
this.o.Sa(a,b)}$(a,b=!0){const c=Bg(this.D,a||"");return void 0===c?null===this.o?void 0:this.o.$(a||"",b):c}};function F(a,b){"*"===b||Array.isArray(b)||(b=[b]);for(let c=1;c<a.length;++c){if(!Array.isArray(a[c]))continue;const d=a[c];if("*"===b||b.includes(d[0]))return d}return null}function H(a){return 2>a.length?"":"object"===typeof a[1]?a[2]||"":a[1]||""}function I(a,b){if(!Array.isArray(a))return null;a=a[1];return"object"!==typeof a||Array.isArray(a)?null:b in a?a[b]:null}function J(a,b){return b.reduce(F,a)}
function K(a,b){const c=[];for(let d=1;d<a.length;++d){if(!Array.isArray(a[d]))continue;const e=a[d];"*"!==b&&e[0]!==b||c.push(e)}return c}function Kg(a){return{localName:H(a),namespaceURI:I(a,"URI"),prefix:I(a,"prefix")}}
function Lg(a){const b=F(a,"typeDeclaration");if(!b||F(b,"voidSequenceType"))return{type:59,g:2};const c=f=>{switch(f[0]){case "documentTest":return 55;case "elementTest":return 54;case "attributeTest":return 47;case "piTest":return 57;case "commentTest":return 58;case "textTest":return 56;case "anyKindTest":return 53;case "anyItemType":return 59;case "anyFunctionTest":case "functionTest":case "typedFunctionTest":return 60;case "anyMapTest":case "typedMapTest":return 61;case "anyArrayTest":case "typedArrayTest":return 62;
...
[M(7,17,"addOp")]:Qb,[M(7,17,"subtractOp")]:Rb,[M(7,16,"addOp")]:Qb,[M(7,16,"subtractOp")]:Rb,[M(8,17,"addOp")]:Qb,[M(8,17,"subtractOp")]:Rb};function Qg(a,b){return v(a,5)&&v(b,5)?5:v(a,4)&&v(b,4)?4:v(a,6)&&v(b,6)?6:3}const Rg=[2,16,17,9,7,8];
function Sg(a,b,c){function d(l,n){return{U:e?e(l):l,V:f?f(n):n}}let e=null,f=null;v(b,19)&&(e=l=>jd(l,3),b=3);v(c,19)&&(f=l=>jd(l,3),c=3);const h=Rg.filter(l=>v(b,l)),k=Rg.filter(l=>v(c,l));if(h.includes(2)&&k.includes(2)){const l=Pg[M(2,2,a)];let n=Og[M(2,2,a)];n||=Qg(b,c);"divOp"===a&&5===n&&(n=4);return"idivOp"===a?Tg(d,l)[0]:(t,u)=>{const {U:z,V:y}=d(t,u);return g(l(z.value,y.value),n)}}for(const l of h)for(const n of k){const t=Pg[M(l,n,a)],u=Og[M(l,n,a)];if(t&&void 0!==u)return(z,y)=>{const {U:G,
V:N}=d(z,y);return g(t(G.value,N.value),u)}}}
function Ug(a,b,c){function d(n,t){return{U:f?f(n):n,V:h?h(t):t}}var e=[2,53,59,46,47];if(e.includes(b)||e.includes(c))return 2;let f=null,h=null;v(b,19)&&(f=n=>jd(n,3),b=3);v(c,19)&&(h=n=>jd(n,3),c=3);var k=Rg.filter(n=>v(b,n));e=Rg.filter(n=>v(c,n));if(k.includes(2)&&e.includes(2)){var l=Og[M(2,2,a)];void 0===l&&(l=Qg(b,c));"divOp"===a&&5===l&&(l=4);return"idivOp"===a?Tg(d,(n,t)=>Math.trunc(n/t))[1]:l}for(l of k)for(const n of e)if(k=Og[M(l,n,a)],void 0!==k)return k}
function Tg(a,b){return[(c,d)=>{const {U:e,V:f}=a(c,d);if(0===f.value)throw Error("FOAR0001: Divisor of idiv operator cannot be (-)0");if(Number.isNaN(e.value)||Number.isNaN(f.value)||!Number.isFinite(e.value))throw Error("FOAR0002: One of the operands of idiv is NaN or the first operand is (-)INF");return Number.isFinite(e.value)&&!Number.isFinite(f.value)?g(0,5):g(b(e.value,f.value),5)},5]}const Vg=Object.create(null);
var Wg=class extends D{constructor(a,b,c,d,e){super(b.o.add(c.o),[b,c],{B:!1},!1,d);this.A=b;this.L=c;this.l=a;this.s=e}h(a,b){return qc(C(this.A,a,b),b).N(c=>0===c.length?w.empty():qc(C(this.L,a,b),b).N(d=>{if(0===d.length)return w.empty();if(1<c.length||1<d.length)throw Error('XPTY0004: the operands of the "'+this.l+'" operator should be empty or singleton.');const e=c[0];d=d[0];if(this.s&&this.type)return w.m(this.s(e,d));var f=e.type;var h=d.type,k=this.l;const l=`${f}~${h}~${k}`;let n=Vg[l];
n||=Vg[l]=Sg(k,f,h);f=n;if(!f)throw Error(`XPTY0004: ${this.l} not available for types ${Da[e.type]} and ${Da[d.type]}`);return w.m(f(e,d))}))}};function Xg(a,b){var c=O;let d=!1;for(var e=1;e<a.length;e++)switch(a[e][0]){case "letClause":Yg(b);var f=a[e],h=b,k=c,l=J(f,["letClauseItem","typedVariableBinding","varName"]);l=Kg(l);f=J(f,["letClauseItem","letExpr"]);k=k(f[1],h);Zg(h,l.localName,k);break;case "forClause":d=!0;Yg(b);$g(a[e],b,c);break;case "whereClause":Yg(b);h=a[e];c(h,b);L(h,"type",{type:0,g:3});break;case "orderByClause":Yg(b);break;case "returnClause":e=a[e];h=c;c=J(e,["*"]);b=h(c,b);L(c,"type",b);L(e,"type",b);c=b;if(!c)return{type:59,
...
var Pi=class extends D{constructor(a,b){const c=a.every(e=>e.W),d=a.every(e=>e.subtree);super(a.reduce((e,f)=>e.add(f.o),new vf({})),a,{B:!1,W:c,R:b?"sorted":"unsorted",subtree:d});this.l=a;this.s=b}h(a,b){let c=!0;return this.l.reduce((d,e,f)=>{const h=null===d?kd(a):dc(a,d);d={next:l=>{l=h.next(l);if(l.done)return p;if(null!==l.value.M&&!v(l.value.M.type,53)&&0<f)throw Error("XPTY0019: The result of E1 in a path expression E1/E2 should not evaluate to a sequence of nodes.");return q(C(e,l.value,
...
function zj(a,b){return qc(b,a).X({m:c=>{c=c.first();if(v(c.type,1)||v(c.type,19)){if(!yj(c.value))throw Error(`XQDY0041: The value "${c.value}" of a name expressions cannot be converted to a NCName.`);return w.m(c)}throw vj();},default:()=>{throw vj();}}).value}
function Aj(a,b,c){return qc(c,b).X({m:d=>{d=d.first();if(v(d.type,23))return w.m(d);if(v(d.type,1)||v(d.type,19)){let e,f;d=d.value.split(":");1===d.length?d=d[0]:(e=d[0],f=a.$(e),d=d[1]);if(!yj(d)||e&&!yj(e))throw yg(e?`${e}:${d}`:d);if(e&&!f)throw yg(`${e}:${d}`);return w.m({type:23,value:new Sa(e,f,d)})}throw vj();},default:()=>{throw vj();}}).value};var Nj=class extends of{constructor(a,b){super(new vf({}),[a,b],{B:!1,R:"unsorted"});this.A=a;this.L=b;this.l=void 0}s(a,b){const c=nf(this.A)(a,b),d=nf(this.L)(a,b);return{next:()=>{const e=c.next(0);var f=e.value.J;if(0===f.length)throw Ye();if(1!==f.length)throw Te();if(!v(f[0].type,54)&&!v(f[0].type,47)&&!v(f[0].type,57))throw Te();f=f[0];const h=d.next(0);a:{var k=this.l;var l=w.create(h.value.J);switch(f.type){case 54:k=Aj(k,b,l).next(0).value.value;if((l=f.value.node.lookupNamespaceURI(k.prefix))&&
...
h=k.value.J[0];k=k.value.da;if(v(h.type,47)){if(d.Xa.length)throw Error("XUTY0011: When replacing an attribute the new value must be zero or more attribute nodes.");d.attributes.reduce((l,n)=>{const t=n.node.prefix||"";n=n.node.namespaceURI;var u=f.node.lookupNamespaceURI(t);if(u&&u!==n)throw We(n);if((u=l[t])&&n!==u)throw Xe(n);l[t]=n;return l},{})}else if(d.attributes.length)throw Error("XUTY0010: When replacing an an element, text, comment, or processing instruction node the new value must be a single node.");
return q({J:[],da:mf([pj(h.value,[].concat(d.attributes,d.Xa))],e,k)})}}}
function Pj(a,b,c){let d,e,f,h,k=!1;return{next:()=>{if(k)return p;if(!f){var l=c.next(0);const n=qc(w.create(l.value.J),a).map(t=>jd(t,1)).O().map(t=>t.value).join(" ");f=0===n.length?null:{node:a.Ja.createTextNode(n),G:null};h=l.value.da}if(!d){l=b.next(0);if(0===l.value.J.length)throw Ye();if(1!==l.value.J.length)throw Se();if(!(v(l.value.J[0].type,54)||v(l.value.J[0].type,47)||v(l.value.J[0].type,56)||v(l.value.J[0].type,58)||v(l.value.J[0].type,57)))throw Se();d=l.value.J[0];e=l.value.da}if(v(d.type,
54))return k=!0,q({J:[],da:mf([new mj(d.value,f)],h,e)});if(v(d.type,47)||v(d.type,56)||v(d.type,58)||v(d.type,57)){l=f?ib(a.h,f):"";if(v(d.type,58)&&(l.includes("--")||l.endsWith("-")))throw Error(`XQDY0072: The content "${l}" for a comment node contains two adjacent hyphens or ends with a hyphen.`);if(v(d.type,57)&&l.includes("?>"))throw Error(`XQDY0026: The content "${l}" for a processing instruction node contains "?>".`);k=!0;return q({J:[],da:mf([new oj(d.value,l)],h,e)})}}}}
var Qj=class extends of{constructor(a,b,c){super(new vf({}),[b,c],{B:!1,R:"unsorted"});this.L=a;this.l=b;this.A=c}s(a,b){const c=nf(this.l)(a,b);a=nf(this.A)(a,b);return this.L?Pj(b,c,a):Oj(b,c,a)}};function Rj(a){switch(a.type){case "delete":return new dj({node:a.target,G:null});case "insertAfter":return new fj({node:a.target,G:null},a.content.map(b=>({node:b,G:null})));case "insertBefore":return new hj({node:a.target,G:null},a.content.map(b=>({node:b,G:null})));case "insertInto":return new kj({node:a.target,G:null},a.content.map(b=>({node:b,G:null})));case "insertIntoAsFirst":return new ij({node:a.target,G:null},a.content.map(b=>({node:b,G:null})));case "insertIntoAsLast":return new jj({node:a.target,
G:null},a.content.map(b=>({node:b,G:null})));case "insertAttributes":return new gj({node:a.target,G:null},a.content.map(b=>({node:b,G:null})));case "rename":return new lj({node:a.target,G:null},a.newName);case "replaceNode":return new nj({node:a.target,G:null},a.replacement.map(b=>({node:b,G:null})));case "replaceValue":return new oj({node:a.target,G:null},a["string-value"]);case "replaceElementContent":return new mj({node:a.target,G:null},a.text?{node:a.text,G:null}:null);default:throw Error(`Unexpected type "${a.type}" when parsing a transferable pending update.`);
}};function Sj(a,b,c){if(b.find(e=>md(e,a)))return!0;const d=x(c,a);return d?Sj(d,b,c):!1}
var Tj=class extends of{constructor(a,b,c){super(new vf({}),a.reduce((d,e)=>{d.push(e.fb);return d},[b,c]),{B:!1,R:"unsorted"});this.l=a;this.L=b;this.A=c;this.I=null}h(a,b){a=this.s(a,b);return pf(a,()=>{})}s(a,b){const c=b.h,d=b.Ja,e=b.Ma,f=[];let h,k,l;const n=[],t=[];return{next:()=>{if(n.length!==this.l.length)for(var u=n.length;u<this.l.length;u++){const y=this.l[u];var z=f[u];z||(f[u]=z=nf(y.fb)(a,b));z=z.next(0);if(1!==z.value.J.length||!v(z.value.J[0].type,53))throw Error("XUTY0013: The source expression of a copy modify expression must return a single node.");
const G=rb(Xf(z.value.J[0].value,b));n.push(G.value);t.push(z.value.da);a=hc(a,{[y.fc]:()=>w.m(G)})}l||(h||=nf(this.L)(a,b),l=h.next(0).value.da);l.forEach(y=>{if(y.target&&!Sj(y.target,n,c))throw Error(`XUDY0014: The target ${y.target.node.outerHTML} must be a node created by the copy clause.`);if("put"===y.type)throw Error("XUDY0037: The modify expression of a copy modify expression can not contain a fn:put.");});u=l.map(y=>{y=y.h(b);return Rj(y)});lf(u,c,d,e);k||=nf(this.A)(a,b);u=k.next(0);return q({J:u.value.J,
da:mf(u.value.da,...t)})}}}v(a){Dg(a);this.l.forEach(b=>b.fc=Hg(a,b.Jb.namespaceURI,b.Jb.localName));super.v(a);Jg(a);this.I=this.l.some(b=>b.fb.I)||this.A.I}};function Uj(a,b){return{node:{nodeType:2,Ra:!0,nodeName:a.za(),namespaceURI:a.namespaceURI,prefix:a.prefix,localName:a.localName,name:a.za(),value:b},G:null}}
var Vj=class extends D{constructor(a,b){let c=b.nb||[];c=c.concat(a.Na||[]);super(new vf({}),c,{B:!1,R:"unsorted"});a.Na?this.s=a.Na:this.name=new Sa(a.prefix,a.namespaceURI,a.localName);this.l=b;this.A=void 0}h(a,b){let c,d,e,f=!1;return w.create({next:()=>{if(f)return p;if(!d){if(this.s){if(!c){var h=this.s.h(a,b);c=Aj(this.A,b,h)}d=c.next(0).value.value}else d=this.name;if(d){if("xmlns"===d.prefix)throw sg(d);if(""===d.prefix&&"xmlns"===d.localName)throw sg(d);if("http://www.w3.org/2000/xmlns/"===
d.namespaceURI)throw sg(d);if("xml"===d.prefix&&"http://www.w3.org/XML/1998/namespace"!==d.namespaceURI)throw sg(d);if(""!==d.prefix&&"xml"!==d.prefix&&"http://www.w3.org/XML/1998/namespace"===d.namespaceURI)throw sg(d);}}if(this.l.nb)return h=this.l.nb,e||(e=jc(h.map(k=>qc(k.h(a,b),b).N(l=>w.m(g(l.map(n=>n.value).join(" "),1))))).N(k=>w.m(rb(Uj(d,k.map(l=>l.value).join(""))))).value),e.next(0);f=!0;return q(rb(Uj(d,this.l.value)))}})}v(a){this.A=Ff(a);if(this.name&&this.name.prefix&&!this.name.namespaceURI){const b=
...
const f=I(a,"type"),h=I(J(a,["firstOperand","*"]),"type"),k=I(J(a,["secondOperand","*"]),"type");h&&k&&I(a,"type")&&(c=Sg(d,h.type,k.type));return new Wg(d,e,b,f,c);case "sequenceExpr":return ik(a,b);case "unionOp":return c=I(a,"type"),new Ii([Q(J(a,["firstOperand","*"]),P(b)),Q(J(a,["secondOperand","*"]),P(b))],c);case "exceptOp":case "intersectOp":return c=I(a,"type"),new yi(a[0],Q(J(a,["firstOperand","*"]),P(b)),Q(J(a,["secondOperand","*"]),P(b)),c);case "stringConcatenateOp":return jk(a,b);case "rangeSequenceExpr":return kk(a,
b);case "equalOp":case "notEqualOp":case "lessThanOrEqualOp":case "lessThanOp":case "greaterThanOrEqualOp":case "greaterThanOp":return lk("generalCompare",a,b);case "eqOp":case "neOp":case "ltOp":case "leOp":case "gtOp":case "geOp":return lk("valueCompare",a,b);case "isOp":case "nodeBeforeOp":case "nodeAfterOp":return lk("nodeCompare",a,b);case "pathExpr":return mk(a,b);case "contextItemExpr":return new Ni(I(a,"type"));case "functionCallExpr":return nk(a,b);case "inlineFunctionExpr":return ok(a,b);
case "arrowExpr":return pk(a,b);case "dynamicFunctionInvocationExpr":return qk(a,b);case "namedFunctionRef":return b=F(a,"functionName"),c=I(a,"type"),a=H(J(a,["integerConstantExpr","value"])),new ai(Kg(b),parseInt(a,10),c);case "integerConstantExpr":return new Zh(H(F(a,"value")),{type:5,g:3});case "stringConstantExpr":return new Zh(H(F(a,"value")),{type:1,g:3});case "decimalConstantExpr":return new Zh(H(F(a,"value")),{type:4,g:3});case "doubleConstantExpr":return new Zh(H(F(a,"value")),{type:3,g:3});
case "varRef":const {prefix:l,namespaceURI:n,localName:t}=Kg(F(a,"name"));return new aj(l,n,t);case "flworExpr":return rk(a,b);case "quantifiedExpr":return sk(a,b);case "ifThenElseExpr":return c=I(a,"type"),d=F(a,"ifClause")||K(a,"x:stackTrace")[0],e=F(a,"thenClause")||K(a,"x:stackTrace")[1],a=F(a,"elseClause")||K(a,"x:stackTrace")[2],new Qh(Q(d,P(b)),Q(e,b),Q(a,b),c);case "instanceOfExpr":return c=Q(J(a,["argExpr","*"]),b),d=J(a,["sequenceType","*"]),e=J(a,["sequenceType","occurrenceIndicator"]),
a=I(a,"type"),new Ei(c,Q(d,P(b)),e?H(e):"",a);case "castExpr":return b=Q(F(F(a,"argExpr"),"*"),P(b)),c=F(a,"singleType"),a=Kg(F(c,"atomicType")),c=null!==F(c,"optional"),new Ci(b,a,c);case "castableExpr":return b=Q(F(F(a,"argExpr"),"*"),P(b)),c=F(a,"singleType"),a=Kg(F(c,"atomicType")),c=null!==F(c,"optional"),new Bi(b,a,c);case "simpleMapExpr":return tk(a,b);case "mapConstructor":return uk(a,b);case "arrayConstructor":return vk(a,b);case "unaryLookup":return c=I(a,"type"),new Ui(wk(a,b),c);case "typeswitchExpr":return xk(a,
b);case "switchExpr":return yk(a,b);case "elementConstructor":return zk(a,b);case "attributeConstructor":return Ak(a,b);case "computedAttributeConstructor":return(c=F(a,"tagName"))?c=Kg(c):(c=F(a,"tagNameExpr"),c={Na:Q(F(c,"*"),P(b))}),b=Q(F(F(a,"valueExpr"),"*"),P(b)),new Vj(c,{nb:[b]});case "computedCommentConstructor":if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");b=(a=F(a,"argExpr"))?Q(F(a,"*"),P(b)):null;return new Wj(b);case "computedTextConstructor":if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");
b=(a=F(a,"argExpr"))?Q(F(a,"*"),P(b)):null;return new bk(b);case "computedElementConstructor":return Bk(a,b);case "computedPIConstructor":if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");c=F(a,"piTargetExpr");d=F(a,"piTarget");e=F(a,"piValueExpr");a=I(a,"type");return new ak({xb:c?Q(F(c,"*"),P(b)):null,Fb:d?H(d):null},e?Q(F(e,"*"),P(b)):new zi([],a));case "CDataSection":return new Zh(H(a),{type:1,g:3});case "deleteExpr":return b=Q(J(a,["targetExpr","*"]),
b),new qj(b);case "insertExpr":c=Q(J(a,["sourceExpr","*"]),b);e=K(a,"*")[1];switch(e[0]){case "insertAfter":d=1;break;case "insertBefore":d=2;break;case "insertInto":d=(d=F(e,"*"))?"insertAsFirst"===d[0]?4:5:3}b=Q(J(a,["targetExpr","*"]),b);return new uj(c,d,b);case "renameExpr":return c=Q(J(a,["targetExpr","*"]),b),b=Q(J(a,["newNameExpr","*"]),b),new Nj(c,b);case "replaceExpr":return c=!!F(a,"replaceValue"),d=Q(J(a,["targetExpr","*"]),b),b=Q(J(a,["replacementExpr","*"]),b),new Qj(c,d,b);case "transformExpr":return Ck(a,
b);case "x:stackTrace":c=a;for(a=c[2];"x:stackTrace"===a[0];)c=a,a=a[2];c=c[1];return new Sh(c,a[0],Q(a,b),c.Wa);case "ifClause":case "thenClause":case "elseClause":return Q(F(a,"*"),b);default:return Dk(a)}}
function Dk(a){switch(a[0]){case "nameTest":return new Yi(Kg(a));case "piTest":return(a=F(a,"piTarget"))?new Zi(H(a)):new Xi(7);case "commentTest":return new Xi(8);case "textTest":return new Xi(3);case "documentTest":return new Xi(9);case "attributeTest":var b=(a=F(a,"attributeName"))&&F(a,"star");return!a||b?new Xi(2):new Yi(Kg(F(a,"QName")),{kind:2});case "elementTest":return b=(a=F(a,"elementName"))&&F(a,"star"),!a||b?new Xi(1):new Yi(Kg(F(a,"QName")),{kind:1});case "anyKindTest":return new $i({prefix:"",
namespaceURI:null,localName:"node()"});case "anyMapTest":return new $i({prefix:"",namespaceURI:null,localName:"map(*)"});case "anyArrayTest":return new $i({prefix:"",namespaceURI:null,localName:"array(*)"});case "Wildcard":return F(a,"star")?(b=F(a,"uri"))?a=new Yi({localName:"*",namespaceURI:H(b),prefix:""}):(b=F(a,"NCName"),a="star"===F(a,"*")[0]?new Yi({localName:H(b),namespaceURI:null,prefix:"*"}):new Yi({localName:"*",namespaceURI:null,prefix:H(b)})):a=new Yi({localName:"*",namespaceURI:null,
prefix:"*"}),a;case "atomicType":return new $i(Kg(a));case "anyItemType":return new $i({prefix:"",namespaceURI:null,localName:"item()"});default:throw Error("No selector counterpart for: "+a[0]+".");}}function vk(a,b){const c=I(a,"type");a=F(a,"*");const d=K(a,"arrayElem").map(e=>Q(F(e,"*"),P(b)));switch(a[0]){case "curlyArray":return new sh(d,c);case "squareArray":return new th(d,c);default:throw Error("Unrecognized arrayType: "+a[0]);}}
function uk(a,b){const c=I(a,"type");return new $h(K(a,"mapConstructorEntry").map(d=>({key:Q(J(d,["mapKeyExpr","*"]),P(b)),value:Q(J(d,["mapValueExpr","*"]),P(b))})),c)}function hk(a,b,c){function d(f){const h=F(F(f,"firstOperand"),"*");f=F(F(f,"secondOperand"),"*");h[0]===a?d(h):e.push(Q(h,c));f[0]===a?d(f):e.push(Q(f,c))}const e=[];d(b);return e}function wk(a,b){a=F(a,"*");switch(a[0]){case "NCName":return new Zh(H(a),{type:1,g:3});case "star":return"*";default:return Q(a,P(b))}}
function lk(a,b,c){var d=J(b,["firstOperand","*"]);const e=J(b,["secondOperand","*"]);d=Q(d,P(c));c=Q(e,P(c));switch(a){case "valueCompare":return new qi(b[0],d,c);case "nodeCompare":return new wi(b[0],d,c);case "generalCompare":return new ti(b[0],d,c)}}
function Ek(a,b,c){a=K(a,"*");return new Li(a.filter(d=>"stable"!==d[0]).map(d=>{var e=F(d,"orderModifier"),f=e?F(e,"orderingKind"):null;e=e?F(e,"emptyOrderingMode"):null;f=f?"ascending"===H(f):!0;e=e?"empty least"===H(e):!0;return{ba:Q(J(d,["orderByExpr","*"]),b),Bb:f,bc:e}}),c)}
function rk(a,b){var c=K(a,"*");a=F(c[c.length-1],"*");c=c.slice(0,-1);if(1<c.length&&!b.Z)throw Error("XPST0003: Use of XQuery FLWOR expressions in XPath is no allowed");return c.reduceRight((d,e)=>{switch(e[0]){case "forClause":e=K(e,"*");for(var f=e.length-1;0<=f;--f){var h=e[f],k=J(h,["forExpr","*"]);const l=F(h,"positionalVariableBinding");d=new Wh(Kg(J(h,["typedVariableBinding","varName"])),Q(k,P(b)),l?Kg(l):null,d)}return d;case "letClause":e=K(e,"*");for(f=e.length-1;0<=f;--f)h=e[f],k=J(h,
["letExpr","*"]),d=new Yh(Kg(J(h,["typedVariableBinding","varName"])),Q(k,P(b)),d);return d;case "whereClause":e=K(e,"*");for(f=e.length-1;0<=f;--f)d=new bj(Q(e[f],b),d);return d;case "windowClause":throw Error(`Not implemented: ${e[0]} is not implemented yet.`);case "groupByClause":throw Error(`Not implemented: ${e[0]} is not implemented yet.`);case "orderByClause":return Ek(e,b,d);case "countClause":throw Error(`Not implemented: ${e[0]} is not implemented yet.`);default:throw Error(`Not implemented: ${e[0]} is not supported in a flwor expression`);
}},Q(a,b))}function nk(a,b){const c=F(a,"functionName"),d=K(F(a,"arguments"),"*");a=I(a,"type");return new Gf(new ai(Kg(c),d.length,a),d.map(e=>"argumentPlaceholder"===e[0]?null:Q(e,b)),a)}
function pk(a,b){const c=I(a,"type");var d=J(a,["argExpr","*"]);a=K(a,"*").slice(1);d=[Q(d,b)];for(let f=0;f<a.length;f++)if("arguments"!==a[f][0]){if("arguments"===a[f+1][0]){var e=K(a[f+1],"*");d=d.concat(e.map(h=>"argumentPlaceholder"===h[0]?null:Q(h,b)))}e="EQName"===a[f][0]?new ai(Kg(a[f]),d.length,c):Q(a[f],P(b));d=[new Gf(e,d,c)]}return d[0]}
function qk(a,b){const c=J(a,["functionItem","*"]),d=I(a,"type");a=F(a,"arguments");let e=[];a&&(e=K(a,"*").map(f=>"argumentPlaceholder"===f[0]?null:Q(f,b)));return new Gf(Q(c,b),e,d)}function ok(a,b){const c=K(F(a,"paramList"),"*"),d=J(a,["functionBody","*"]),e=I(a,"type");return new Xh(c.map(f=>({name:Kg(F(f,"varName")),type:Lg(f)})),Lg(a),d?Q(d,b):new zi([],e))}
function mk(a,b){const c=I(a,"type");var d=K(a,"stepExpr");let e=!1;var f=d.map(h=>{var k=F(h,"xpathAxis");let l;var n=K(h,"*");const t=[];let u=null,z=!1;for(const y of n)switch(y[0]){case "lookup":t.push(["lookup",wk(y,b)]);break;case "predicate":case "predicates":for(const G of K(y,"*")){n=Q(G,P(b));if(!z){const N=n.D();null===N?z=!0:u=yh(u,N)}t.push(["predicate",n])}}if(k)switch(e=!0,h=F(h,"attributeTest anyElementTest piTest documentTest elementTest commentTest namespaceTest anyKindTest textTest anyFunctionTest typedFunctionTest schemaAttributeTest atomicType anyItemType parenthesizedItemType typedMapTest typedArrayTest nameTest Wildcard".split(" ")),
h=Dk(h),H(k)){case "ancestor":l=new wh(h,{Qa:!1});break;case "ancestor-or-self":l=new wh(h,{Qa:!0});break;case "attribute":l=new zh(h,u);break;case "child":l=new Ah(h,u);break;case "descendant":l=new Dh(h,{Qa:!1});break;case "descendant-or-self":l=new Dh(h,{Qa:!0});break;case "parent":l=new Kh(h,u);break;case "following-sibling":l=new Jh(h,u);break;case "preceding-sibling":l=new Oh(h,u);break;case "following":l=new Hh(h);break;case "preceding":l=new Mh(h);break;case "self":l=new Ph(h,u)}else k=J(h,
["filterExpr","*"]),l=Q(k,P(b));for(const y of t)switch(y[0]){case "lookup":l=new Ti(l,y[1]);break;case "predicate":l=new Qi(l,y[1])}l.type=c;return l});a=F(a,"rootExpr");d=e||null!==a||1<d.length;if(!d&&1===f.length||!a&&1===f.length&&"sorted"===f[0].ia)return f[0];if(a&&0===f.length)return new Mi(null);f=new Pi(f,d);return a?new Mi(f):f}
function sk(a,b){const c=I(a,"type"),d=H(F(a,"quantifier")),e=J(a,["predicateExpr","*"]);a=K(a,"quantifiedExprInClause").map(f=>{const h=Kg(J(f,["typedVariableBinding","varName"]));f=J(f,["sourceExpr","*"]);return{name:h,fb:Q(f,P(b))}});return new Vi(d,a,Q(e,P(b)),c)}function ik(a,b){var c=K(a,"*").map(d=>Q(d,b));if(1===c.length)return c[0];c=I(a,"type");return new zi(K(a,"*").map(d=>Q(d,b)),c)}
function tk(a,b){const c=I(a,"type");return K(a,"*").reduce((d,e)=>null===d?Q(e,P(b)):new Ai(d,Q(e,P(b)),c),null)}function jk(a,b){const c=I(a,"type");a=[J(a,["firstOperand","*"]),J(a,["secondOperand","*"])];return new Gf(new ai({localName:"concat",namespaceURI:"http://www.w3.org/2005/xpath-functions",prefix:""},a.length,c),a.map(d=>Q(d,P(b))),c)}
function kk(a,b){const c=I(a,"type");a=[F(F(a,"startExpr"),"*"),F(F(a,"endExpr"),"*")];const d=new ai({localName:"to",namespaceURI:"http://fontoxpath/operators",prefix:""},a.length,c);return new Gf(d,a.map(e=>Q(e,P(b))),c)}
function zk(a,b){if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");const c=Kg(F(a,"tagName"));var d=F(a,"attributeList");const e=d?K(d,"attributeConstructor").map(f=>Q(f,P(b))):[];d=d?K(d,"namespaceDeclaration").map(f=>{const h=F(f,"prefix");return{prefix:h?H(h):"",uri:H(F(f,"uri"))}}):[];a=(a=F(a,"elementContent"))?K(a,"*").map(f=>Q(f,P(b))):[];return new Xj(c,e,d,a)}
function Ak(a,b){if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");const c=Kg(F(a,"attributeName"));var d=F(a,"attributeValue");d=d?H(d):null;a=(a=F(a,"attributeValueExpr"))?K(a,"*").map(e=>Q(e,P(b))):null;return new Vj(c,{value:d,nb:a})}function Bk(a,b){var c=F(a,"tagName");c?c=Kg(c):(c=F(a,"tagNameExpr"),c={Na:Q(F(c,"*"),P(b))});a=(a=F(a,"contentExpr"))?K(a,"*").map(d=>Q(d,P(b))):[];return new Xj(c,[],[],a)}
function Ck(a,b){const c=K(F(a,"transformCopies"),"transformCopy").map(e=>{const f=Kg(F(F(e,"varRef"),"name"));return{fb:Q(F(F(e,"copySource"),"*"),b),Jb:new Sa(f.prefix,f.namespaceURI,f.localName)}}),d=Q(F(F(a,"modifyExpr"),"*"),b);a=Q(F(F(a,"returnExpr"),"*"),b);return new Tj(c,d,a)}
function xk(a,b){if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");const c=I(a,"type"),d=Q(F(F(a,"argExpr"),"*"),b),e=K(a,"typeswitchExprCaseClause").map(f=>{const h=0===K(f,"sequenceTypeUnion").length?[F(f,"sequenceType")]:K(F(f,"sequenceTypeUnion"),"sequenceType");return{pb:Q(J(f,["resultExpr","*"]),b),Ib:h.map(k=>{const l=F(k,"occurrenceIndicator");return{dc:l?H(l):"",Hb:Q(F(k,"*"),b)}})}});a=Q(J(a,["typeswitchExprDefaultClause","resultExpr","*"]),b);
return new ck(d,e,a,c)}function yk(a,b){if(!b.Z)throw Error("XPST0003: Use of XQuery functionality is not allowed in XPath context");const c=I(a,"type"),d=Q(F(F(a,"argExpr"),"*"),b),e=K(a,"switchExprCaseClause").map(f=>{const h=K(f,"switchCaseExpr");return{pb:Q(J(f,["resultExpr","*"]),b),Gb:h.map(k=>Q(F(k,"*"),b))}});a=Q(J(a,["switchExprDefaultClause","resultExpr","*"]),b);return new dk(d,e,a,c)}function Fk(a,b){return Q(a,b)};const Gk=new Map;class Hk{constructor(a,b,c,d,e,f){this.v=a;this.D=b;this.h=c;this.kb=d;this.o=e;this.l=f}}function Ik(a,b,c,d,e,f,h,k){a=Gk.get(a);if(!a)return null;b=a[b+(f?"_DEBUG":"")];return b?(b=b.find(l=>l.o===h&&l.v.every(n=>c(n.prefix)===n.namespaceURI)&&l.D.every(n=>void 0!==d[n.name])&&l.kb.every(n=>e[n.prefix]===n.namespaceURI)&&l.l.every(n=>{const t=k(n.cc,n.arity);return t&&t.namespaceURI===n.Db.namespaceURI&&t.localName===n.Db.localName})))?{ba:b.h,hc:!1}:null:null}
...
"end"!==f.localName||"stackTrace"!==a.localName?"type"===f.localName?e[f.localName]=Ja(f.value):e[f.localName]=f.value:e[f.localName]=JSON.parse(f.value);return e},{}));b=b.getChildNodes(a);for(const e of b)switch(e.nodeType){case 1:c.push(Kk(e));break;case 3:c.push(e.data)}return c};const Lk=Object.create(null);
var Mk=(a,b)=>{let c=Lk[a];c||=Lk[a]={Ia:[],Ta:[],pa:null,source:b.source};const d=c.pa||(()=>{});c.Ia=c.Ia.concat(b.Ia);c.Ta=c.Ta.concat(b.Ta);c.pa=e=>{d(e);b.pa&&b.pa(e)}},Nk=(a,b)=>{const c=Lk[b];if(!c)throw Error(`XQST0051: No modules found with the namespace uri ${b}`);c.Ia.forEach(d=>{d.cb&&Fg(a,b,d.localName,d.arity,d)});c.Ta.forEach(d=>{Hg(a,b,d.localName);Ig(a,b,d.localName,(e,f)=>C(d.ba,e,f))})},Ok=()=>{Object.keys(Lk).forEach(a=>{a=Lk[a];if(a.pa)try{a.pa(a)}catch(b){a.pa=null,hg(a.source,
b)}a.pa=null})};function Pk(a){return a.replace(/(\x0D\x0A)|(\x0D(?!\x0A))/g,String.fromCharCode(10))};var R=prsc;function Qk(a,b){return(c,d)=>{if(b.has(d))return b.get(d);c=a(c,d);b.set(d,c);return c}}function S(a,b){return(0,R.delimited)(b,a,b)}function T(a,b){return a.reverse().reduce((c,d)=>(0,R.preceded)(d,c),b)}function Rk(a,b,c,d){return(0,R.then)((0,R.then)(a,b,(e,f)=>[e,f]),c,([e,f],h)=>d(e,f,h))}function Sk(a,b,c,d,e){return(0,R.then)((0,R.then)((0,R.then)(a,b,(f,h)=>[f,h]),c,([f,h],k)=>[f,h,k]),d,([f,h,k],l)=>e(f,h,k,l))}
function Tk(a,b,c,d,e,f){return(0,R.then)((0,R.then)((0,R.then)((0,R.then)(a,b,(h,k)=>[h,k]),c,([h,k],l)=>[h,k,l]),d,([h,k,l],n)=>[h,k,l,n]),e,([h,k,l,n],t)=>f(h,k,l,n,t))}function Uk(a){return(0,R.map)(a,b=>[b])}function Vk(a,b){return(0,R.map)((0,R.or)(a),()=>b)}function Wk(a){return(b,c)=>(b=a.exec(b.substring(c)))&&0===b.index?(0,R.okWithValue)(c+b[0].length,b[0]):(0,R.error)(c,[a.source],!1)};var Xk=(0,R.or)([(0,R.token)(" "),(0,R.token)("\t"),(0,R.token)("\r"),(0,R.token)("\n")]),Yk=(0,R.token)("(:"),Zk=(0,R.token)(":)"),$k=(0,R.token)("(#"),al=(0,R.token)("#)"),bl=(0,R.token)("("),cl=(0,R.token)(")"),dl=(0,R.token)("["),el=(0,R.token)("]"),fl=(0,R.token)("{"),gl=(0,R.token)("}"),hl=(0,R.token)("{{"),il=(0,R.token)("}}"),jl=(0,R.token)("'"),kl=(0,R.token)("''"),ll=(0,R.token)('"'),ml=(0,R.token)('""'),nl=(0,R.token)("<![CDATA["),ol=(0,R.token)("]]\x3e"),pl=(0,R.token)("/>"),ql=(0,R.token)("</"),
rl=(0,R.token)("\x3c!--"),sl=(0,R.token)("--\x3e"),tl=(0,R.token)("<?"),ul=(0,R.token)("?>"),vl=(0,R.token)("&#x"),wl=(0,R.token)("&#"),xl=(0,R.token)(":*"),yl=(0,R.token)("*:"),zl=(0,R.token)(":="),Al=(0,R.token)("&"),Bl=(0,R.token)(":"),Cl=(0,R.token)(";"),Dl=(0,R.token)("*"),El=(0,R.token)("@"),Fl=(0,R.token)("$"),Gl=(0,R.token)("#"),Hl=(0,R.token)("%"),Il=(0,R.token)("?"),Jl=(0,R.token)("="),Kl=(0,R.followed)((0,R.token)("!"),(0,R.not)((0,R.peek)(Jl),[])),Ll=(0,R.followed)((0,R.token)("|"),(0,R.not)((0,R.peek)((0,R.token)("|")),
[])),Ml=(0,R.token)("||"),Nl=(0,R.token)("!="),Ol=(0,R.token)("<"),Pl=(0,R.token)("<<"),Ql=(0,R.token)("<="),Rl=(0,R.token)(">"),Sl=(0,R.token)(">>"),Tl=(0,R.token)(">="),Ul=(0,R.token)(","),Vl=(0,R.token)("."),Wl=(0,R.token)(".."),Xl=(0,R.token)("+"),Yl=(0,R.token)("-"),Zl=(0,R.token)("/"),$l=(0,R.token)("//"),am=(0,R.token)("=>"),bm=(0,R.token)("e"),cm=(0,R.token)("E");(0,R.token)("l");(0,R.token)("L");(0,R.token)("m");(0,R.token)("M");var dm=(0,R.token)("Q");(0,R.token)("x");(0,R.token)("X");
var em=(0,R.token)("as"),fm=(0,R.token)("cast"),gm=(0,R.token)("castable"),hm=(0,R.token)("treat"),im=(0,R.token)("instance"),jm=(0,R.token)("of"),km=(0,R.token)("node"),lm=(0,R.token)("nodes"),mm=(0,R.token)("delete"),nm=(0,R.token)("value"),om=(0,R.token)("function"),pm=(0,R.token)("map"),qm=(0,R.token)("element"),rm=(0,R.token)("attribute"),sm=(0,R.token)("schema-element"),tm=(0,R.token)("intersect"),um=(0,R.token)("except"),vm=(0,R.token)("union"),wm=(0,R.token)("to"),xm=(0,R.token)("is"),ym=
(0,R.token)("or"),zm=(0,R.token)("and"),Am=(0,R.token)("div"),Bm=(0,R.token)("idiv"),Cm=(0,R.token)("mod"),Dm=(0,R.token)("eq"),Em=(0,R.token)("ne"),Fm=(0,R.token)("lt"),Gm=(0,R.token)("le"),Hm=(0,R.token)("gt"),Im=(0,R.token)("ge"),Jm=(0,R.token)("amp"),Km=(0,R.token)("quot"),Lm=(0,R.token)("apos"),Mm=(0,R.token)("if"),Nm=(0,R.token)("then"),Om=(0,R.token)("else"),Pm=(0,R.token)("allowing"),Qm=(0,R.token)("empty"),Rm=(0,R.token)("at"),Sm=(0,R.token)("in"),Tm=(0,R.token)("for"),Um=(0,R.token)("let"),
Vm=(0,R.token)("where"),Wm=(0,R.token)("collation"),Xm=(0,R.token)("group"),Ym=(0,R.token)("by"),Zm=(0,R.token)("order"),$m=(0,R.token)("stable"),an=(0,R.token)("return"),bn=(0,R.token)("array"),cn=(0,R.token)("document"),dn=(0,R.token)("namespace"),en=(0,R.token)("text"),fn=(0,R.token)("comment"),gn=(0,R.token)("processing-instruction"),hn=(0,R.token)("lax"),jn=(0,R.token)("strict"),kn=(0,R.token)("validate"),ln=(0,R.token)("type"),mn=(0,R.token)("declare"),nn=(0,R.token)("default"),on=(0,R.token)("boundary-space"),
pn=(0,R.token)("strip"),qn=(0,R.token)("preserve"),rn=(0,R.token)("no-preserve"),sn=(0,R.token)("inherit"),tn=(0,R.token)("no-inherit"),un=(0,R.token)("greatest"),vn=(0,R.token)("least"),wn=(0,R.token)("copy-namespaces"),xn=(0,R.token)("decimal-format"),yn=(0,R.token)("case"),zn=(0,R.token)("typeswitch"),An=(0,R.token)("some"),Bn=(0,R.token)("every"),Cn=(0,R.token)("satisfies"),Dn=(0,R.token)("replace"),En=(0,R.token)("with"),Fn=(0,R.token)("copy"),Gn=(0,R.token)("modify"),Hn=(0,R.token)("first"),
In=(0,R.token)("last"),Jn=(0,R.token)("before"),Kn=(0,R.token)("after"),Ln=(0,R.token)("into"),Mn=(0,R.token)("insert"),Nn=(0,R.token)("rename"),On=(0,R.token)("switch"),Pn=(0,R.token)("variable"),Qn=(0,R.token)("external"),Rn=(0,R.token)("updating"),Sn=(0,R.token)("import"),Tn=(0,R.token)("schema"),Un=(0,R.token)("module"),Vn=(0,R.token)("base-uri"),Wn=(0,R.token)("construction"),Xn=(0,R.token)("ordering"),Yn=(0,R.token)("ordered"),Zn=(0,R.token)("unordered"),$n=(0,R.token)("option"),ao=(0,R.token)("context"),
bo=(0,R.token)("item"),co=(0,R.token)("xquery"),eo=(0,R.token)("version"),fo=(0,R.token)("encoding"),go=(0,R.token)("document-node"),ho=(0,R.token)("namespace-node"),io=(0,R.token)("schema-attribute"),jo=(0,R.token)("ascending"),ko=(0,R.token)("descending"),lo=(0,R.token)("empty-sequence"),mo=(0,R.token)("child::"),no=(0,R.token)("descendant::"),oo=(0,R.token)("attribute::"),po=(0,R.token)("self::"),qo=(0,R.token)("descendant-or-self::"),ro=(0,R.token)("following-sibling::"),so=(0,R.token)("following::"),
to=(0,R.token)("parent::"),uo=(0,R.token)("ancestor::"),vo=(0,R.token)("preceding-sibling::"),wo=(0,R.token)("preceding::"),xo=(0,R.token)("ancestor-or-self::"),yo=(0,R.token)("decimal-separator"),zo=(0,R.token)("grouping-separator"),Ao=(0,R.token)("infinity"),Bo=(0,R.token)("minus-sign"),Co=(0,R.token)("NaN"),Do=(0,R.token)("per-mille"),Eo=(0,R.token)("zero-digit"),Fo=(0,R.token)("digit"),Go=(0,R.token)("pattern-separator"),Ho=(0,R.token)("exponent-separator"),Io=(0,R.token)("schema-attribute("),
Jo=(0,R.token)("document-node("),Ko=(0,R.token)("processing-instruction("),Lo=(0,R.token)("processing-instruction()"),Mo=(0,R.token)("comment()"),No=(0,R.token)("text()"),Oo=(0,R.token)("namespace-node()"),Po=(0,R.token)("node()"),Qo=(0,R.token)("item()"),Ro=(0,R.token)("empty-sequence()");var So=new Map,To=new Map,Uo=(0,R.or)([Wk(/[\t\n\r -\uD7FF\uE000\uFFFD]/),Wk(/[\uD800-\uDBFF][\uDC00-\uDFFF]/)]),Vo=(0,R.preceded)((0,R.peek)((0,R.not)((0,R.or)([Yk,Zk]),['comment contents cannot contain "(:" or ":)"'])),Uo),Wo=(0,R.map)((0,R.delimited)(Yk,(0,R.star)((0,R.or)([Vo,function(a,b){return Wo(a,b)}])),Zk,!0),a=>a.join("")),Xo=(0,R.or)([Xk,Wo]),Yo=(0,R.map)((0,R.plus)(Xk),a=>a.join("")),V=Qk((0,R.map)((0,R.star)(Xo),a=>a.join("")),So),W=Qk((0,R.map)((0,R.plus)(Xo),a=>a.join("")),To);const Zo=(0,R.or)([Wk(/[A-Z_a-z\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/),(0,R.then)(Wk(/[\uD800-\uDB7F]/),Wk(/[\uDC00-\uDFFF]/),(a,b)=>a+b)]),$o=(0,R.or)([Zo,Wk(/[\-\.0-9\xB7\u0300-\u036F\u203F\u2040]/)]);var ap=(0,R.then)(Zo,(0,R.star)($o),(a,b)=>a+b.join("")),bp=(0,R.map)(ap,a=>["prefix",a]);const cp=(0,R.or)([Zo,Bl]),dp=(0,R.or)([$o,Bl]);(0,R.then)(cp,(0,R.star)(dp),(a,b)=>a+b.join(""));
const ep=(0,R.map)(ap,a=>[{prefix:"",URI:null},a]),fp=(0,R.then)(ap,(0,R.preceded)(Bl,ap),(a,b)=>[{prefix:a,URI:null},b]);var gp=(0,R.or)([fp,ep]),hp=(0,R.followed)(T([dm,V,fl],(0,R.map)((0,R.star)(Wk(/[^{}]/)),a=>a.join("").replace(/\s+/g," ").trim())),gl);const ip=(0,R.then)(hp,ap,(a,b)=>[a,b]);var jp=(0,R.or)([(0,R.map)(ip,a=>[{prefix:null,URI:a[0]},a[1]]),gp]),kp=(0,R.or)([(0,R.map)(jp,a=>["QName",...a]),(0,R.map)(Dl,()=>["star"])]),lp=(0,R.map)((0,R.preceded)(Fl,jp),a=>["varRef",["name",...a]]);var mp=(0,R.peek)((0,R.or)([bl,ll,jl,Xo])),np=(0,R.map)((0,R.or)([mo,no,oo,po,qo,ro,so]),a=>a.substring(0,a.length-2)),op=(0,R.map)((0,R.or)([to,uo,vo,wo,xo]),a=>a.substring(0,a.length-2)),pp=Rk(Al,(0,R.or)([Fm,Hm,Jm,Km,Lm]),Cl,(a,b,c)=>a+b+c),qp=(0,R.or)([Rk(vl,Wk(/[0-9a-fA-F]+/),Cl,(a,b,c)=>a+b+c),Rk(wl,Wk(/[0-9]+/),Cl,(a,b,c)=>a+b+c)]),rp=Vk([ml],'"'),sp=Vk([kl],"'"),tp=Uk(Vk([Mo],"commentTest")),up=Uk(Vk([No],"textTest")),vp=Uk(Vk([Oo],"namespaceTest")),wp=Uk(Vk([Po],"anyKindTest"));
const xp=Wk(/[0-9]+/),yp=(0,R.then)((0,R.or)([(0,R.then)(Vl,xp,(a,b)=>a+b),(0,R.then)(xp,(0,R.optional)((0,R.preceded)(Vl,Wk(/[0-9]*/))),(a,b)=>a+(null!==b?"."+b:""))]),Rk((0,R.or)([bm,cm]),(0,R.optional)((0,R.or)([Xl,Yl])),xp,(a,b,c)=>a+(b?b:"")+c),(a,b)=>["doubleConstantExpr",["value",a+b]]),zp=(0,R.or)([(0,R.map)((0,R.preceded)(Vl,xp),a=>["decimalConstantExpr",["value","."+a]]),(0,R.then)((0,R.followed)(xp,Vl),(0,R.optional)(xp),(a,b)=>["decimalConstantExpr",["value",a+"."+(null!==b?b:"")]])]);
var Ap=(0,R.map)(xp,a=>["integerConstantExpr",["value",a]]),Bp=(0,R.followed)((0,R.or)([yp,zp,Ap]),(0,R.peek)((0,R.not)(Wk(/[a-zA-Z]/),["no alphabetical characters after numeric literal"]))),Cp=(0,R.map)((0,R.followed)(Vl,(0,R.peek)((0,R.not)(Vl,["context item should not be followed by another ."]))),()=>["contextItemExpr"]),Dp=(0,R.or)([bn,rm,fn,go,qm,lo,om,Mm,bo,pm,ho,km,gn,io,sm,On,en,zn]),Ep=Uk(Vk([Il],"argumentPlaceholder")),Fp=(0,R.or)([Il,Dl,Xl]),Gp=(0,R.preceded)((0,R.peek)((0,R.not)(Wk(/[{}<&]/),
["elementContentChar cannot be {, }, <, or &"])),Uo),Hp=(0,R.map)((0,R.delimited)(nl,(0,R.star)((0,R.preceded)((0,R.peek)((0,R.not)(ol,['CDataSection content may not contain "]]\x3e"'])),Uo)),ol,!0),a=>["CDataSection",a.join("")]),Ip=(0,R.preceded)((0,R.peek)((0,R.not)(Wk(/["{}<&]/),['quotAttrValueContentChar cannot be ", {, }, <, or &'])),Uo),Jp=(0,R.preceded)((0,R.peek)((0,R.not)(Wk(/['{}<&]/),["aposAttrValueContentChar cannot be ', {, }, <, or &"])),Uo),Kp=(0,R.map)((0,R.star)((0,R.or)([(0,R.preceded)((0,R.peek)((0,R.not)(Yl,
[])),Uo),(0,R.map)(T([Yl,(0,R.peek)((0,R.not)(Yl,[]))],Uo),a=>"-"+a)])),a=>a.join("")),Lp=(0,R.map)((0,R.delimited)(rl,Kp,sl,!0),a=>["computedCommentConstructor",["argExpr",["stringConstantExpr",["value",a]]]]);const Mp=(0,R.filter)(ap,a=>"xml"!==a.toLowerCase(),['A processing instruction target cannot be "xml"']),Np=(0,R.map)((0,R.star)((0,R.preceded)((0,R.peek)((0,R.not)(ul,[])),Uo)),a=>a.join(""));
var Op=(0,R.then)((0,R.preceded)(tl,(0,R.cut)(Mp)),(0,R.cut)((0,R.followed)((0,R.optional)((0,R.preceded)(Yo,Np)),ul)),(a,b)=>["computedPIConstructor",["piTarget",a],["piValueExpr",["stringConstantExpr",["value",b]]]]),Pp=(0,R.map)($l,()=>["stepExpr",["xpathAxis","descendant-or-self"],["anyKindTest"]]),Qp=(0,R.or)([hn,jn]),Rp=(0,R.map)((0,R.star)((0,R.followed)(Uo,(0,R.peek)((0,R.not)(al,["Pragma contents should not contain '#)'"])))),a=>a.join("")),Sp=(0,R.map)((0,R.followed)((0,R.or)([Dm,Em,Fm,
Gm,Hm,Im]),mp),a=>a+"Op"),Tp=(0,R.or)([(0,R.followed)(Vk([xm],"isOp"),mp),Vk([Pl],"nodeBeforeOp"),Vk([Sl],"nodeAfterOp")]),Up=(0,R.or)([Vk([Jl],"equalOp"),Vk([Nl],"notEqualOp"),Vk([Ql],"lessThanOrEqualOp"),Vk([Ol],"lessThanOp"),Vk([Tl],"greaterThanOrEqualOp"),Vk([Rl],"greaterThanOp")]),Vp=(0,R.map)(Rn,()=>["annotation",["annotationName","updating"]]);const Wp=(0,R.or)([qn,rn]),Xp=(0,R.or)([sn,tn]);
...
a]}function eq(a){if(!(1<=a&&55295>=a||57344<=a&&65533>=a||65536<=a&&1114111>=a))throw Error("XQST0090: The character reference "+a+" ("+a.toString(16)+") does not reference a valid codePoint.");}
function fq(a){return a.replace(/(&[^;]+);/g,b=>{if(/^&#x/.test(b))return b=parseInt(b.slice(3,-1),16),eq(b),String.fromCodePoint(b);if(/^&#/.test(b))return b=parseInt(b.slice(2,-1),10),eq(b),String.fromCodePoint(b);switch(b){case "&lt;":return"<";case "&gt;":return">";case "&amp;":return"&";case "&quot;":return String.fromCharCode(34);case "&apos;":return String.fromCharCode(39)}throw Error('XPST0003: Unknown character reference: "'+b+'"');})}
function gq(a,b,c){if(!a.length)return[];let d=[a[0]];for(let e=1;e<a.length;++e){const f=d[d.length-1];"string"===typeof f&&"string"===typeof a[e]?d[d.length-1]=f+a[e]:d.push(a[e])}if("string"===typeof d[0]&&0===d.length)return[];d=d.reduce((e,f,h)=>{if("string"!==typeof f)e.push(f);else if(c&&/^\s*$/.test(f)){const k=d[h+1];k&&"CDataSection"===k[0]?e.push(fq(f)):(h=d[h-1])&&"CDataSection"===h[0]&&e.push(fq(f))}else e.push(fq(f));return e},[]);if(!d.length)return d;if(1<d.length||b)for(a=0;a<d.length;a++)"string"===
typeof d[a]&&(d[a]=["stringConstantExpr",["value",d[a]]]);return d}function hq(a){return a[0].prefix?a[0].prefix+":"+a[1]:a[1]};var iq=(0,R.then)(jp,(0,R.optional)(Il),(a,b)=>null!==b?["singleType",["atomicType",...a],["optional"]]:["singleType",["atomicType",...a]]),jq=(0,R.map)(jp,a=>["atomicType",...a]);const kq=new Map;
function lq(a){function b(m,r){return r.reduce((B,X)=>[X[0],["firstOperand",B],["secondOperand",X[1]]],m)}function c(m,r,B){return(0,R.then)(m,(0,R.star)((0,R.then)(S(r,V),(0,R.cut)(m),(X,ea)=>[X,ea])),B)}function d(m,r,B="firstOperand",X="secondOperand"){return(0,R.then)(m,(0,R.optional)((0,R.then)(S(r,V),(0,R.cut)(m),(ea,Fa)=>[ea,Fa])),(ea,Fa)=>null===Fa?ea:[Fa[0],[B,ea],[X,Fa[1]]])}function e(m){return a.mb?(r,B)=>{r=m(r,B);if(!r.success)return r;const X=n.has(B)?n.get(B):{offset:B,line:-1,ha:-1},
ea=n.has(r.offset)?n.get(r.offset):{offset:r.offset,line:-1,ha:-1};n.set(B,X);n.set(r.offset,ea);B=r.value.Wa;return(0,R.okWithValue)(r.offset,["x:stackTrace",Object.assign({start:X,end:ea},B?{Wa:B}:{}),r.value])}:m}function f(m,r){return Bj(m,r)}function h(m,r){return yf(m,r)}function k(m,r){return e((0,R.or)([zr,Ar,Br,Cr,Dr,Er,Fr,Gr,Hr,Ir,Jr]))(m,r)}function l(m,r){return c(k,Ul,(B,X)=>0===X.length?B:["sequenceExpr",B,...X.map(ea=>ea[1])])(m,r)}const n=new Map,t=(0,R.preceded)(dl,(0,R.followed)(S(l,
V),el)),u=(0,R.map)(a.Za?(0,R.or)([S((0,R.star)((0,R.or)([pp,qp,rp,Wk(/[^"&]/)])),ll),S((0,R.star)((0,R.or)([pp,qp,sp,Wk(/[^'&]/)])),jl)]):(0,R.or)([S((0,R.star)((0,R.or)([rp,Wk(/[^"]/)])),ll),S((0,R.star)((0,R.or)([sp,Wk(/[^']/)])),jl)]),m=>m.join("")),z=(0,R.or)([(0,R.map)(T([qm,V],(0,R.delimited)((0,R.followed)(bl,V),(0,R.then)(kp,T([V,Ul,V],jp),(m,r)=>[["elementName",m],["typeName",...r]]),(0,R.preceded)(V,cl))),([m,r])=>["elementTest",m,r]),(0,R.map)(T([qm,V],(0,R.delimited)(bl,kp,cl)),m=>["elementTest",
["elementName",m]]),(0,R.map)(T([qm,V],(0,R.delimited)(bl,V,cl)),()=>["elementTest"])]),y=(0,R.or)([(0,R.map)(jp,m=>["QName",...m]),(0,R.map)(Dl,()=>["star"])]),G=(0,R.or)([(0,R.map)(T([rm,V],(0,R.delimited)((0,R.followed)(bl,V),(0,R.then)(y,T([V,Ul,V],jp),(m,r)=>[["attributeName",m],["typeName",...r]]),(0,R.preceded)(V,cl))),([m,r])=>["attributeTest",m,r]),(0,R.map)(T([rm,V],(0,R.delimited)(bl,y,cl)),m=>["attributeTest",["attributeName",m]]),(0,R.map)(T([rm,V],(0,R.delimited)(bl,V,cl)),()=>["attributeTest"])]),
N=(0,R.map)(T([sm,V,bl],(0,R.followed)(jp,cl)),m=>["schemaElementTest",...m]),U=(0,R.map)((0,R.delimited)(Io,S(jp,V),cl),m=>["schemaAttributeTest",...m]),ca=(0,R.map)((0,R.preceded)(Jo,(0,R.followed)(S((0,R.optional)((0,R.or)([z,N])),V),cl)),m=>["documentTest",...(m?[m]:[])]),Ga=(0,R.or)([(0,R.map)((0,R.preceded)(Ko,(0,R.followed)(S((0,R.or)([ap,u]),V),cl)),m=>["piTest",["piTarget",m]]),Uk(Vk([Lo],"piTest"))]),Gb=(0,R.or)([ca,z,G,N,U,Ga,tp,up,vp,wp]),Xb=(0,R.or)([(0,R.map)((0,R.preceded)(yl,ap),m=>
["Wildcard",["star"],["NCName",m]]),Uk(Vk([Dl],"Wildcard")),(0,R.map)((0,R.followed)(hp,Dl),m=>["Wildcard",["uri",m],["star"]]),(0,R.map)((0,R.followed)(ap,xl),m=>["Wildcard",["NCName",m],["star"]])]),fd=(0,R.or)([Xb,(0,R.map)(jp,m=>["nameTest",...m])]),Yb=(0,R.or)([Gb,fd]),Kr=(0,R.then)((0,R.optional)(El),Yb,(m,r)=>null!==m||"attributeTest"===r[0]||"schemaAttributeTest"===r[0]?["stepExpr",["xpathAxis","attribute"],r]:["stepExpr",["xpathAxis","child"],r]),Lr=(0,R.or)([(0,R.then)(np,Yb,(m,r)=>["stepExpr",
["xpathAxis",m],r]),Kr]),Mr=(0,R.map)(Wl,()=>["stepExpr",["xpathAxis","parent"],["anyKindTest"]]),Nr=(0,R.or)([(0,R.then)(op,Yb,(m,r)=>["stepExpr",["xpathAxis",m],r]),Mr]),Or=(0,R.map)((0,R.star)((0,R.preceded)(V,t)),m=>0<m.length?["predicates",...m]:void 0),Pr=(0,R.then)((0,R.or)([Nr,Lr]),Or,(m,r)=>void 0===r?m:m.concat([r])),zf=(0,R.or)([Bp,(0,R.map)(u,m=>["stringConstantExpr",["value",a.Za?fq(m):m]])]),Af=(0,R.or)([(0,R.delimited)(bl,S(l,V),cl),(0,R.map)((0,R.delimited)(bl,V,cl),()=>["sequenceExpr"])]),
Cj=(0,R.or)([k,Ep]),de=(0,R.map)((0,R.delimited)(bl,S((0,R.optional)((0,R.then)(Cj,(0,R.star)((0,R.preceded)(S(Ul,V),Cj)),(m,r)=>[m,...r])),V),cl),m=>null!==m?m:[]),Qr=(0,R.preceded)((0,R.not)(Rk(Dp,V,bl,()=>{}),["cannot use reserved keyword for function names"]),e((0,R.then)(jp,(0,R.preceded)(V,de),(m,r)=>{r=["functionCallExpr",["functionName",...m],null!==r?["arguments",...r]:["arguments"]];const B=m[0].prefix,X=m[0].URI;m=m[1];r.Wa=B?`${B}:${m}`:X?`Q{${X}}${m}`:m;return r}))),Rr=(0,R.then)(jp,
(0,R.preceded)(Gl,Ap),(m,r)=>["namedFunctionRef",["functionName",...m],r]),Ta=(0,R.delimited)(fl,S((0,R.optional)(l),V),gl),Dj=(0,R.map)(Ta,m=>m?m:["sequenceExpr"]),gb=(0,R.or)([(0,R.map)(Ro,()=>[["voidSequenceType"]]),(0,R.then)(f,(0,R.optional)((0,R.preceded)(V,Fp)),(m,r)=>[m,...(null!==r?[["occurrenceIndicator",r]]:[])])]),Bf=(0,R.then)(T([Hl,V],jp),(0,R.optional)((0,R.followed)((0,R.then)(T([bl,V],zf),(0,R.star)(T([Ul,V],zf)),(m,r)=>m.concat(r)),cl)),(m,r)=>["annotation",["annotationName",...m],
...(r?["arguments",r]:[])]),Sr=(0,R.map)(T([om,V,bl,V,Dl,V],cl),()=>["anyFunctionTest"]),Tr=(0,R.then)(T([om,V,bl,V],(0,R.optional)(c(gb,Ul,(m,r)=>m.concat.apply(m,r.map(B=>B[1]))))),T([V,cl,W,em,W],gb),(m,r)=>["typedFunctionTest",["paramTypeList",["sequenceType",...(m?m:[])]],["sequenceType",...r]]),Ur=(0,R.then)((0,R.star)(Bf),(0,R.or)([Sr,Tr]),(m,r)=>[r[0],...m,...r.slice(1)]),Vr=(0,R.map)(T([pm,V,bl,V,Dl,V],cl),()=>["anyMapTest"]),Wr=(0,R.then)(T([pm,V,bl,V],jq),T([V,Ul],(0,R.followed)(S(gb,V),
cl)),(m,r)=>["typedMapTest",m,["sequenceType",...r]]),Xr=(0,R.or)([Vr,Wr]),Yr=(0,R.map)(T([bn,V,bl,V,Dl,V],cl),()=>["anyArrayTest"]),Zr=(0,R.map)(T([bn,V,bl],(0,R.followed)(S(gb,V),cl)),m=>["typedArrayTest",["sequenceType",...m]]),$r=(0,R.or)([Yr,Zr]),as=(0,R.map)((0,R.delimited)(bl,S(f,V),cl),m=>["parenthesizedItemType",m]),Bj=(0,R.or)([Gb,Uk(Vk([Qo],"anyItemType")),Ur,Xr,$r,jq,as]),Ac=(0,R.map)(T([em,W],gb),m=>["typeDeclaration",...m]),bs=(0,R.then)((0,R.preceded)(Fl,jp),(0,R.optional)((0,R.preceded)(W,
Ac)),(m,r)=>["param",["varName",...m],...(r?[r]:[])]),Ej=c(bs,Ul,(m,r)=>[m,...r.map(B=>B[1])]),cs=Sk((0,R.star)(Bf),T([V,om,V,bl,V],(0,R.optional)(Ej)),T([V,cl,V],(0,R.optional)((0,R.map)(T([em,V],(0,R.followed)(gb,V)),m=>["typeDeclaration",...m]))),Dj,(m,r,B,X)=>["inlineFunctionExpr",...m,["paramList",...(r?r:[])],...(B?[B]:[]),["functionBody",X]]),ds=(0,R.or)([Rr,cs]),es=(0,R.map)(k,m=>["mapKeyExpr",m]),fs=(0,R.map)(k,m=>["mapValueExpr",m]),gs=(0,R.then)(es,(0,R.preceded)(S(Bl,V),fs),(m,r)=>["mapConstructorEntry",
m,r]),hs=(0,R.preceded)(pm,(0,R.delimited)(S(fl,V),(0,R.map)((0,R.optional)(c(gs,S(Ul,V),(m,r)=>[m,...r.map(B=>B[1])])),m=>m?["mapConstructor",...m]:["mapConstructor"]),(0,R.preceded)(V,gl))),is=(0,R.map)((0,R.delimited)(dl,S((0,R.optional)(c(k,Ul,(m,r)=>[m,...r.map(B=>B[1])].map(B=>["arrayElem",B]))),V),el),m=>["squareArray",...(null!==m?m:[])]),js=(0,R.map)((0,R.preceded)(bn,(0,R.preceded)(V,Ta)),m=>["curlyArray",...(null!==m?[["arrayElem",m]]:[])]),ks=(0,R.map)((0,R.or)([is,js]),m=>["arrayConstructor",
...
d).value,ec:a}}catch(f){hg(a.value,f)}};function zq(a,b,c){if(1!==b.node.nodeType&&9!==b.node.nodeType)return[];const d=hb(a,b).reduce((e,f)=>{for(const h of zq(a,f,c))e.push(h);return e},[]);c(b)&&d.unshift(b);return d}
...
return Z(rr(f,u,"multiple"),z=>{if(1!==z.ua.type)return or("can only generate general compare for a single value and a generator");const y=du(f,eu(f,"n")),G=tr(y,k,f);return Z(e,N=>Z(G,U=>Y(`(function () {
									...
									return false;
								})()`,{type:0},[...t.H,...y.H,...N.H,...z.H])))})})};function fu(a){return JSON.stringify(a).replace(/\u2028/g,"\\u2028").replace(/\u2029/g,"\\u2029")};const lu={"false#0":gu,"local-name#0":hu,"local-name#1":hu,"name#0":iu,"name#1":iu,"not#1":ju,"true#0":ku},mu={["http://fontoxml.com/fontoxpath"]:["version#0"],[""]:["root#1","path#1"]};
...
function ou(a,b,c,d){if(a.length!==b.length||b.some(l=>4===l))return or("Not supported: variadic function or mismatch in argument count");if(0===a.length)return Y("",{type:0},[]);const [e,...f]=a,[h,...k]=b;a=rr(d,nu(e,h,c,d),"arg");return 0===f.length?a:Z(a,l=>{const n=ou(f,k,c,d);return Z(n,t=>Y(`${l.code}, ${t.code}`,{type:0},[...l.H,...t.H]))})}
function pu(a,b){return Z(a,c=>(b?2===b.g||1===b.g:1)||![0,1].includes(b.type)&&!v(b.type,53)?or(`Function return type ${Da[b.type]} not supported`):c)}
function qu(a,b,c){const {localName:d,namespaceURI:e}=Kg(F(a,"functionName")),f=K(F(a,"arguments"),"*");var h=f.length;const k=`${d}#${h}`,l=e===c.D;if(l){const n=lu[k];if(void 0!==n)return n(a,b,c)}if((a=mu[l?"":e])&&!a.includes(k))return or(`Not supported: built-in function not on allow list: ${k}`);h=ng(e,d,h);if(!h)return or(`Unknown function / arity: ${k}`);if(h.I)return or("Not supported: updating functions");b=ou(f,h.j,b,c);b=Z(b,n=>Y(`runtimeLib.callFunction(domFacade, ${fu(e)}, ${fu(d)}, [${n.code}], options)`,
{type:0},n.H));return pu(b,h.i)}function ru(a,b){return Z(rr(b,a,"contextItem"),c=>Y(c.code,{type:0},[...c.H,`if (${c.code} === undefined || ${c.code} === null) {
		...
		+ (${d}.localName || ${d}.target || ''))`)}function hu(a,b,c){return su(a,b,c,d=>`(${d}.localName || ${d}.target || '')`)}function ju(a,b,c){var d=J(a,["arguments","*"]);a=I(d,"type");[d]=c.h(d,b,c);b=sr(d,a,b,c);return Z(b,e=>Y(`!${e.code}`,{type:0},e.H))}function gu(){return Y("false",{type:0},[])}function ku(){return Y("true",{type:0},[])};function tu(a,b,c,d){const [e,f]=yr(a,"firstOperand",c,d);var h=I(J(a,["firstOperand","*"]),"type");h=sr(e,h,c,d);const [k,l]=yr(a,"secondOperand",c,d);h=Z(h,t=>{var u=I(J(a,["secondOperand","*"]),"type");u=sr(k,u,c,d);return Z(u,z=>Y(`(${t.code} ${b} ${z.code})`,{type:0},[...t.H,...z.H]))});const n="&&"===b?yh(f,l):f===l?f:null;return[h,n]};function uu(a,b,c){return Z(a,d=>Z(b,e=>Z(c,f=>Y(`for (${d.code}) {
						...
						${f.H.join("\n")}
						${f.code}
					}`,{type:2},d.H))))}function vu(a,b,c,d,e){const f=b?`, "${b}"`:"";b=Z(d,h=>Z(e,k=>Y(`let ${h.code} = domFacade.getFirstChild(${k.code}${f});
							${h.code};
							${h.code} = domFacade.getNextSibling(${h.code}${f})`,{type:2},[...h.H,...k.H])));return uu(b,a,c)}function wu(a,b,c,d,e){const f=yh(b,"type-2"),h=Z(e,k=>Y(`(${k.code} && ${k.code}.nodeType === /*ELEMENT_NODE*/ ${1} ? domFacade.getAllAttributes(${k.code}${f?`, "${f}"`:""}) : [])`,{type:0},k.H));b=Z(d,k=>Z(h,l=>Y(`const ${k.code} of ${l.code}`,{type:2},[...k.H,...l.H])));return uu(b,a,c)}
function xu(a,b,c,d,e){const f=b?`, "${b}"`:"";b=Z(e,h=>Y(`domFacade.getParentNode(${h.code}${f})`,{type:0},h.H));return yu(d,b,a,c)}function yu(a,b,c,d){const e=xr(a,c);return Z(a,f=>Z(b,h=>Z(e,k=>Z(d,l=>Y(`const ${f.code} = ${h.code};
						${k.H.join("\n")}
						if (${k.code}) {
							${l.H.join("\n")}
							${l.code}
						}`,{type:2},[...f.H,...h.H])))))}function zu(a,b,c,d,e,f){a=H(a);switch(a){case "attribute":return[wu(b,c,d,e,f),"type-1"];case "child":return[vu(b,c,d,e,f),null];case "parent":return[xu(b,c,d,e,f),null];case "self":return[yu(e,f,b,d),c];default:return[or(`Unsupported: the ${a} axis`),null]}};const Au={Wb:"textTest",Nb:"elementTest",Sb:"nameTest",Xb:"Wildcard",Kb:"anyKindTest"};var Bu=Object.values(Au);function Cu(a){return[Z(a,b=>Y(`(${b.code}.nodeType === /*TEXT_NODE*/ ${3} ||
				${b.code}.nodeType === /* CDATA_SECTION_NODE */ ${4})`,{type:0},[])),"type-3"]}function Du(a,b){if(null===a.namespaceURI&&"*"!==a.prefix){b=b.$(a.prefix||"")||null;if(!b&&a.prefix)throw Error(`XPST0081: The prefix ${a.prefix} could not be resolved.`);a.namespaceURI=b}}function Eu(a,b,c,d){Du(a,d);const e=a.prefix,f=a.namespaceURI,h=a.localName;return pr(c,k=>{var l=b?Y(`${k.code}.nodeType
						&& (${k.code}.nodeType === /*ELEMENT_NODE*/ ${1}
						|| ${k.code}.nodeType === /*ATTRIBUTE_NODE*/ ${2})`,{type:0},[]):Y(`${k.code}.nodeType
						&& ${k.code}.nodeType === /*ELEMENT_NODE*/ ${1}`,{type:0},[]);if("*"===e)return"*"===h?[l,b?"type-1-or-type-2":"type-1"]:[xr(l,Y(`${k.code}.localName === ${fu(h)}`,{type:0},[])),`name-${h}`];l="*"===h?l:xr(l,Y(`${k.code}.localName === ${fu(h)}`,{type:0},[]));var n=Y(fu(f),{type:0},[]);n=""===e&&b?Z(n,t=>Y(`${k.code}.nodeType === /*ELEMENT_NODE*/ ${1} ? ${t.code} : null`,{type:0},t.H)):n;n=Z(n,t=>Y(`(${k.code}.namespaceURI || null) === ((${t.code}) || null)`,{type:0},t.H));return[xr(l,n),`name-${h}`]})}
function Fu(a,b,c){const d=(a=F(a,"elementName"))&&F(a,"star");if(null===a||d)return[Z(b,e=>Y(`${e.code}.nodeType === /*ELEMENT_NODE*/ ${1}`,{type:0},[])),"type-1"];a=Kg(F(a,"QName"));return Eu(a,!1,b,c)}function Gu(a){return[Z(a,b=>Y(`!!${b.code}.nodeType`,{type:0},[])),null]}
function Hu(a,b,c,d){var e=a[0];switch(e){case Au.Nb:return Fu(a,c,d);case Au.Wb:return Cu(c);case Au.Sb:return Eu(Kg(a),b,c,d);case Au.Xb:return F(a,"star")?(e=F(a,"uri"),null!==e?a=Eu({localName:"*",namespaceURI:H(e),prefix:""},b,c,d):(e=F(a,"NCName"),a="star"===F(a,"*")[0]?Eu({localName:H(e),namespaceURI:null,prefix:"*"},b,c,d):Eu({localName:"*",namespaceURI:null,prefix:H(e)},b,c,d))):a=Eu({localName:"*",namespaceURI:null,prefix:"*"},b,c,d),a;case Au.Kb:return Gu(c);default:return[or(`Test not implemented: '${e}`),
null]}};function Iu(a,b,c){const [d,e]=c.h(a,b,c);return[sr(d,I(a,"type"),b,c),e]}function Ju(a,b,c){a=a?K(a,"*"):[];const [d,e]=a.reduce(([f,h],k)=>{if(!f)return Iu(k,b,c);let l=h;return pr(f,n=>{const [t,u]=Iu(k,b,c);l=yh(h,u);return[Z(t,z=>Y(`${n.code} && ${z.code}`,{type:0},[...n.H,...z.H])),l]})},[null,null]);return[d?Z(d,f=>Y(`(function () {
							${f.H.join("\n")}
							return ${f.code};
						})()`,{type:0},[])):null,e]}
...
if(!a)return[or("Unsupported: unknown step type"),null];const [u,z]=d.h(a,c,d);return[Z(u,y=>{const G=0===f.length?Y("",{type:2},[]):Y(`if (${h.code} !== null && !${h.code}.nodeType) {
									throw new Error('XPTY0019: The result of E1 in a path expression E1/E2 should evaluate to a sequence of nodes.');
								}`,{type:2},[]),[N]=Ku(f,!0,h,d),U=null===k?N:Z(k,ca=>Z(N,Ga=>Y(`if (${ca.code}) {
									${Ga.H.join("\n")}
									${Ga.code}
							...
							if (${h.code} !== null) {
								${ca.H.join("\n")}
								${ca.code}
							}`,{type:2},[...h.H,...y.H,...G.H]);default:return or("Unsupported generated code type for filterExpr")}})}),z]}function Lu(a){return Z(a,b=>Y(`(function () {
				let n = ${b.code};
...
function $u(a,b,c,d,e){if("string"===typeof c)return 0===c.length?null:b.createTextNode(c);if(!Array.isArray(c))throw new TypeError("JsonML element should be an array or string");var f=Zu(c[0],d);d=f.localName;f=f.lb;const h=b.createElementNS(f,Yu[f]+":"+d),k=c[1];var l=1;if("object"===typeof k&&!Array.isArray(k)){if(null!==k)for(var n of Object.keys(k))l=k[n],null!==l&&("type"===n?void 0!==l&&a.setAttributeNS(h,f,"fontoxpath:"+n,Ha(l)):("start"!==n&&"end"!==n&&"comment"!==n||"stackTrace"!==d||(l=
JSON.stringify(l)),e&&"prefix"===n&&""===l||a.setAttributeNS(h,f,Yu[f]+":"+n,l)));l=2}for(let t=l,u=c.length;t<u;++t)n=$u(a,b,c[t],f,e),null!==n&&a.insertBefore(h,n,null);return h}
function av(a,b,c,d=ab){a=Pk(a);let e;try{e=qq(a,{Z:"XQuery3.1"===b.language||"XQueryUpdate3.1"===b.language,debug:b.debug})}catch(l){hg(a,l)}var f=new qg(b.namespaceResolver||(()=>null),{},void 0===b.defaultFunctionNamespaceURI?"http://www.w3.org/2005/xpath-functions":b.defaultFunctionNamespaceURI,b.functionNameResolver||(()=>null));f=new Cg(f);var h=F(e,["mainModule","libraryModule"]),k=F(h,"moduleDecl");if(k){const l=H(F(k,"prefix"));k=H(F(k,"uri"));Gg(f,l,k)}(h=F(h,"prolog"))&&tq(h,f,!1,a);!1!==
b.annotateAst&&jh(e,new rh(f));f=new Za;b=$u(d,c,e,null,!1===b.mc);d.insertBefore(b,c.createComment(a),f.getFirstChild(b));return b};function bv(a){return Promise.resolve(a)};function cv(a,b={debug:!1}){try{var c=qq(a,{Z:!0,debug:b.debug})}catch(f){hg(a,f)}jh(c,new rh);b=F(c,"libraryModule");if(!b)throw Error("XQuery module must be declared in a library module.");c=F(b,"moduleDecl");var d=F(c,"uri");const e=H(d);c=F(c,"prefix");d=H(c);c=new Cg(new qg(()=>null,Object.create(null),"http://www.w3.org/2005/xpath-functions",Oq("http://www.w3.org/2005/xpath-functions")));Gg(c,d,e);b=F(b,"prolog");if(null!==b){let f;try{f=tq(b,c,!0,a)}catch(h){hg(a,h)}f.Ia.forEach(({namespaceURI:h})=>
{if(e!==h)throw Error("XQST0048: Functions and variables declared in a module must reside in the module target namespace.");});Mk(e,f)}else Mk(e,{Ia:[],Ta:[],pa:null,source:a});return e};const dv=new Map;function ev(a){var b;a:{if(b=Gk.get(a))for(const c of Object.keys(b))if(b[c]&&b[c].length){b=b[c][0].h;break a}b=null}if(b)return b;if(dv.has(a))return dv.get(a);b="string"===typeof a?qq(a,{Z:!1}):Kk(a);b=J(b,["mainModule","queryBody","*"]);if(null===b)throw Error("Library modules do not have a specificity");b=Fk(b,{sa:!1,Z:!1});dv.set(a,b);return b}function fv(a){return ev(a).D()}function gv(a,b){return uf(ev(a).o,ev(b).o)}var hv=new Za;
...
av,fontoxpathGlobal.profiler=Xq,fontoxpathGlobal.createTypedValueFactory=Mq,fontoxpathGlobal.finalizeModuleRegistration=Ok,fontoxpathGlobal.Language=Zq,fontoxpathGlobal.ReturnType=Tq);
