module.exports =
	...
	(function () {
		...
		function peg$parse(input, options) {
			...
			const peg$c9 = 'select';
			const peg$c10 = peg$literalExpectation('select', false);
			const peg$c11 = function () {
				if (options.strictNumberSign) {
					inPlural = false;
				}
			};
			const peg$c12 = 'plural';
			const peg$c13 = peg$literalExpectation('plural', false);
			const peg$c14 = 'selectordinal';
			const peg$c15 = peg$literalExpectation('selectordinal', false);
			...
			const peg$c19 = function () {
				throw new Error('Dashes are not allowed (-)');
			};
			const peg$c20 =
			...
			const peg$c28 = /^[^}]/;
			const peg$c29 = peg$classExpectation(['}'], true, false);
			const peg$c30 = "''";
			...
			const peg$c42 = /^[^{}#\0-\x08\x0E-\x1F\x7F]/;
