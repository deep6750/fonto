...
const EDITOR_RUN_DOCUMENTATION_URL =
	'https://documentation.fontoxml.com/latest/development-server-4fe6e4d66c2a';
...
export default (moduleRegistration, editorCommand) => {
	editorCommand
		...
		.addOption(
			'dist-auth',
			undefined,
			'Enable basic authentication in dist mode (deprecated).'
		)
		.addOption(
			'lock-not-acquired',
			'l',
		...
		.addOption(
			'write-to-disk',
			undefined,
			'Write the intermediate development builds to the dev directory on disk.'
		)
