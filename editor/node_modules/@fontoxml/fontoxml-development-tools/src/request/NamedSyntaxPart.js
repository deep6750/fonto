...
export default class NamedSyntaxPart {
	 ...
	 * @return {*}
	 */
	[symbols.spliceInputFromParts](_parts) {
		throw new Error('Not implemented.');
	}
	 ...
	 * @param {*} input
	 */
	[symbols.createContributionToRequestObject](_accumulated, _input) {
		throw new Error('Not implemented.');
	}

	[symbols.applyDefault](value, _isUndefined) {
		return value;
	}
	 ...
	 * @return {Array}
	 */
	[symbols.updateTiersAfterMatch](_tiers) {
		throw new Error('Not implemented.');
	}
